...
var handleTransaction = function (txEvent) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                findings = [];
                return [4 /*yield*/, web3.eth.getTransaction("0xfd544e466294d92b53e62728d12d7f781bcb751910ee074d9bf23a795fc17d4b")];
            case 1:
                data = _a.sent();
                console.log(data.value);
                if (txEvent.from === "0x1ad91ee08f21be3de0ba2ba6918e714da6b45836") {
                }
